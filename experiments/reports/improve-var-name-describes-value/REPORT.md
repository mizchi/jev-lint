...
| 5 | `threshold:` ts 0.6 -> 0.5, rust 0.47 -> 0.55; rust `bytes` used with `.to_uppercase()` | 1.00/0.83 (1) | 1.00/0.90 (2) | ts: `userIds` [0.72 0.16 0.17] is the flip; rust: `ids` [0.61 0.50 0.61], `bytes` [0.69 0.39 0.38] both across 0.55 |
...
| 9 | rust `threshold:` 0.55 -> 0.5; `--accept`; `--replay` passes | 1.00/0.92 (1) | 1.00/0.90 (2) | the accepted baseline; numbers in the table above |
