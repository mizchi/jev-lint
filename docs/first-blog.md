...
プリセットのルールは現時点で 6 pack 22 ルール。ラベル付き corpus に対して閾値を fit してあり、22 のうち 21 は corpus 上で precision / recall 1.0 ですが、corpus は小さいので、自分のコードでは再フィットする前提です。ここから増やしていきます。
...
- 約 9,800 行、22 ルール、1,950 subject に対して、7.7 秒掛かって約 8 円 ($0.055)
